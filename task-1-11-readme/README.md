...
### 在线学习参考资料
* [MDN:手机网页开发](https://developer.mozilla.org/en/docs/Web/Guide/Mobile)
* [MDN:在移动浏览器中使用viewport元标签控制布局](https://developer.mozilla.org/en/docs/Mobile/Viewport_meta_tag)
...
### 高分团队
团队：[锟斤拷](http://ife.baidu.com/group/profile?groupId=1304)
代码地址：https://github.com/qiuxiang/ife2016/tree/gh-pages/tasks/1-11
demo：http://qiuxiang.github.io/ife2016/tasks/1-11/dist/index.html